...
import {
  GroupItem, AssociationItem, DutItem, ChillerXaParamsGrouped, ChillerHxParamsGrouped,
  ChillerXaHvarParamsGrouped,
} from './exportRealTime';
...
export interface API_private1 {
  ...
  ['/batch-input-columns']: (reqParams: {
    ...
    dris?: {
      ...
      FANCOIL_MANUF: { label: string, exampleList: string[] },
      FANCOIL_MODEL: { label: string, exampleList: string[] },
  ...
  ['/energy/get-analysis-list']: (reqParams: {
    ...
    unitsList?: {
      ...
      consumptionPreviousPercentage: string
    }[]
  }>
 ...
 ['/update-model-rate']: (reqParams: {
  ...
  ['/get-integrations-list']: (reqParams: {
    ...
    list: {
      ...
      supplier: 'Diel'|'Oxyn'|'NESS'|'GreenAnt'|'CoolAutomation'|'Laager'
  ...
  ['/mainservice/api-registries/get-combo-opts']: (session: SessionData, extra: ExtraRouteParams) => Promise<{
  ...
  ['/mainservice/api-registries/update-api']: (reqParams: {
    id: number,
    body: Partial<{
      clientId: number,
      clientName: string,
